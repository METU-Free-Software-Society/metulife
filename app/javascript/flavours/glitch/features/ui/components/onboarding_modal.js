...
const PageSix = ({ admin, domain }) => {
  ...
  return (
    <div className='onboarding-modal__page onboarding-modal__page-six'>
      ...
      {adminSection}
	<p><FormattedMessage id='onboarding.page_six.github' defaultMessage='{domain} is a free as in freedom software, running {fork} of {Mastodon}. View our {github}. You can donate at {patreon} to support us.' values={{ domain, fork: <a href='https://en.wikipedia.org/wiki/Fork_(software_development)' target='_blank' rel='noopener'>fork</a>, Mastodon: <a href='https://github.com/glitch-soc/mastodon' target='_blank' rel='noopener'>glitch-soc/mastodon</a>, github: <a href='https://git.oyd.org.tr/MetuFSS/metu.life' target='_blank' rel='noopener'>source code</a>, patreon: <a href='https://patreon.com/MetuLife' target='_blank' rel='noopener'>Patreon</a> }} /></p>
      <p><FormattedMessage id='onboarding.page_six.apps_available' defaultMessage='There are {apps} available for iOS, Android and other platforms.' values={{ domain, apps: <a href='/apps/index.html' target='_blank' rel='noopener'><FormattedMessage id='onboarding.page_six.various_app' defaultMessage='mobile apps' /></a> }} /></p>
