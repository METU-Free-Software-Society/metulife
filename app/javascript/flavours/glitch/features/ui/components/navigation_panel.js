...
const NavigationPanel = ({ onOpenSettings }) => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/timelines/tag/2021METUSpringJournal'><Icon className='column-link__icon' id='hashtag' fixedWidth /><FormattedMessage id='navigation_bar.journal' defaultMessage='Spring Journal'></FormattedMessage></NavLink>
